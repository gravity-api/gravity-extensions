 ...
 * 
 * TODO: re-factor [FromTable] method to comply with @data-column instead of data-column
 */
...
namespace Gravity.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        #region *** Validation ***
        /// <summary>
        /// Return a value indicates if this <see cref="string"/> is a valid, able to compile JSON.
        /// </summary>
        /// <param name="str"><see cref="string"/> on which to perform validation.</param>
        ...
        /// <summary>
        /// Return a value indicates if this <see cref="string"/> is a valid, able to compile XML.
        /// </summary>
        /// <param name="xml"><see cref="string"/> on which to perform validation.</param>
        ...
        /// </summary>
        /// <param name="str"><see cref="string"/> to populate by.</param>
        /// <param name="dataTable"><see cref="DataTable"/> to get data from.</param>
        /// <returns>A collection <see cref="string"/>, for each <see cref="DataRow"/>.</returns>
        public static IEnumerable<string> FromTable(this string str, DataTable dataTable)
        {
            // collect columns
